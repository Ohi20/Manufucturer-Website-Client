...
import deb from "../../Assets/images/deb.png";
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={html} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={css} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={boot} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={tail} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={js} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={deb} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={rest} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={reactt} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={fire} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={node} />
    </div>
...
<div class="card lg:card-side bg-base-100 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div className='text-center'>
    <img class="mask mask-hexagon max-w-sm"  width={200} height={200} src={mongo} />
    </div>
...
<div class="flex flex-col w-full lg:flex-row mb-10">
  <div class="grid flex-grow h-32 card  rounded-box place-items-center">
    <img width="210px" height="100px" src={react1} alt=''></img>
    </div> 
  <div class="divider lg:divider-horizontal text-primary">AND</div> 
  <div class="grid flex-grow h-32 card  rounded-box place-items-center">
  <img  width="200px" height="100px" src={mongo} alt=''></img>
  </div>
</div> 
